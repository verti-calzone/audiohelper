...
MusicalMoveBlock.placements = {
    name = "musicalmoveblock",
    data = {
        width = 16,
        height = 16,
        direction = "Right",
        canSteer = false,
        fast = false,
        ActivateSound = "event:/game/04_cliffside/arrowblock_activate",
        MoveSound = "event:/game/04_cliffside/arrowblock_move",
        BreakSound = "event:/game/04_cliffside/arrowblock_break",
        ReformSound = "event:/game/04_cliffside/arrowblock_reform_begin",
...
function MusicalMoveBlock.sprite(room, entity)
