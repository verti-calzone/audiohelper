...
MusicalSwapBlock.name = "audiohelper/MusicalSwapBlock"
MusicalSwapBlock.nodeLimits = {1, 1}
MusicalSwapBlock.fieldInformation = {
    theme = {
...
function MusicalSwapBlock.sprite(room, entity)
    local sprites = {}
...
function MusicalSwapBlock.nodeSprite(room, entity, node)
    local sprites = {}
...
function MusicalSwapBlock.selection(room, entity)
    local nodes = entity.nodes or {}
    local x, y = entity.x or 0, entity.y or 0
    local nodeX, nodeY = nodes[1].x or x, nodes[1].y or y
    local width, height = entity.width or 8, entity.height or 8
